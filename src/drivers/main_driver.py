...
parser.add_argument('--cfg_file', type=str, default='/ogr_cmu/src/configs/params/hgr_shrec_2017/Oracle-BN.yaml',
                    required=False, help='config file to load experimental parameters.')
parser.add_argument('--root_dir', type=str, default='/ogr_cmu/data/SHREC_2017', required=False,
                    help='root directory containing the dataset.')
parser.add_argument('--log_dir', type=str, default='/ogr_cmu/output/hgr_shrec_2017/Oracle-BN', required=False,
